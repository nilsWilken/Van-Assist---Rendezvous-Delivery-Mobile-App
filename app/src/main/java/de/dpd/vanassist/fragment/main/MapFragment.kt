...
class MapFragment : Fragment(), OnMapReadyCallback, MapboxMap.OnMapClickListener, ProgressChangeListener, NavigationListener, NavigationEventListener {
    ...
    companion object {
        ...
        fun newInstance(): MapFragment {
            FragmentRepo.mapFragment = MapFragment()
            return FragmentRepo.mapFragment as MapFragment
        }
    }
